            ...
            <Grid item xs={12} md={6} lg={6} style={{ position: 'relative' }}>
              ...
              {inText !== '' && (
                <button
                  ...
                  className={`${translateStyle.closeBtn}  ${translateStyle.classicBtn}`}
                >
                  <CloseIcon />
                </button>
              )}
              {inText !== '' && (
                <div className={translateStyle.actions}>
                  <IconButton onClick={() => {}} className={translateStyle.classicBtn}>
                    <VolumeUpIcon />
                  </IconButton>
                </div>
              )}
                ...
                <div className={translateStyle.actions}>
                  <span>
                    ...
                    <IconButton
                      color="primary"
                      aria-label="copy"
                      onClick={() => copyHandler(resText)}
                      className={translateStyle.classicBtn}
                    >
                      <ContentCopyIcon />
                    </IconButton>
                  </span>
          ...
          <ul style={{ listStyle: 'none', padding: 'unset', width: '100%' }}>
            ...
            <li className={translateStyle.suggestForm} style={{}}>
              ...
              >
                ...
                />
                <IconButton aria-label="copy" onClick={() => {}} className={translateStyle.sendBtn}>
                  <SendIcon />
                </IconButton>
              </span>
            </li>
